...
- **Location**: `/app/music/` (symlinked to `/app/frontend/`)
...
- [x] Transposition mode supports cross-scale-type transposition
- [x] Updated Home page descriptions (keys → scales)
- [x] Updated Results page to show scale info
- [x] All 5 game modes tested and working (95% test pass rate)
...
## Prioritized Backlog
- P1: Add correct answer feedback display on wrong answers
...
## Next Tasks
- Consider showing the correct answer when the user gets it wrong
