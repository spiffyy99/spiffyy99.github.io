...
export const CHORD_NOTE_TYPES = {
  ...
  dim:      { intervals: [0, 3, 6],             label: 'Dim',     suffix: 'dim',    group: 'dim'   },
  ...
  halfdim7: { intervals: [0, 3, 6, 10],         label: '\u00f87', suffix: '\u00f87', group: 'dim'  },
  dim7:     { intervals: [0, 3, 6, 9],          label: '\u00b07', suffix: '\u00b07', group: 'dim'  },
